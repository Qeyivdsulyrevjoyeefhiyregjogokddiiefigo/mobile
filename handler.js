...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    mods: '*٬࿊⃟❗ 𝗣𝗲𝗿𝗶𝗻𝘁𝗮𝗵 𝗜𝗻𝗶 𝗗𝗮𝗽𝗮𝘁 𝗗𝗶𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗢𝗹𝗲𝗵*',
    premium: '*٬࿊⃟❗ 𝗣𝗲𝗿𝗶𝗻𝘁𝗮𝗵 𝗜𝗻𝗶 𝗗𝗮𝗽𝗮𝘁 𝗗𝗶𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗢𝗹𝗲𝗵*',
    group: '*٬࿊⃟❗ 𝗣𝗲𝗿𝗶𝗻𝘁𝗮𝗵 𝗜𝗻𝗶 𝗗𝗮𝗽𝗮𝘁 𝗗𝗶𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗢𝗹𝗲𝗵*',
    private: '*٬࿊⃟❗ 𝗣𝗲𝗿𝗶𝗻𝘁𝗮𝗵 𝗜𝗻𝗶 𝗗𝗮𝗽𝗮𝘁 𝗗𝗶𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗢𝗹𝗲𝗵*',
    admin: '*٬࿊⃟❗ 𝗣𝗲𝗿𝗶𝗻𝘁𝗮𝗵 𝗜𝗻𝗶 𝗗𝗮𝗽𝗮𝘁 𝗗𝗶𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗢𝗹𝗲𝗵*',
    botAdmin: '٬࿊⃟❗ 𝗣𝗲𝗿𝗶𝗻𝘁𝗮𝗵 𝗜𝗻𝗶 𝗗𝗮𝗽𝗮𝘁 𝗗𝗶𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗢𝗹𝗲𝗵',
    unreg: 'Silahkan daftar untuk menggunakan fitur ini dengan cara mengetik:\n\n*#daftar nama.umur*\n\nContoh: *#daftar Rasel.18*',
    nsfw: '٬࿊⃟❗ 𝗣𝗲𝗿𝗶𝗻𝘁𝗮𝗵 𝗜𝗻𝗶 𝗗𝗮𝗽𝗮𝘁 𝗗𝗶𝗴𝘂𝗻𝗮𝗸𝗮𝗻 𝗢𝗹𝗲𝗵'
  }[type]
